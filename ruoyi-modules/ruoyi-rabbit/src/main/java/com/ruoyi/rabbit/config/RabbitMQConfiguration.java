...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//    @Bean
//    public Queue commentStudentReportQueue(){
//        return new Queue(QueueEnum.STUDENT_COMMENT_REPORT.getName());
//    }
//
//
//    //创建直接类型交换机
//    @Bean
//    DirectExchange commentStudentReportExchange(){
//        return (DirectExchange) ExchangeBuilder
//                .directExchange(QueueEnum.STUDENT_COMMENT_REPORT.getExchange())
//                .durable(true)
//                .build();
//    }
//
//    //延时交换机绑定队列
//    @Bean
//    Binding commentStudentReportBinding(DirectExchange commentStudentReportExchange,Queue commentStudentReportQueue){
//        return BindingBuilder
//                .bind(commentStudentReportQueue)
//                .to(commentStudentReportExchange)
//                .with(QueueEnum.STUDENT_COMMENT_REPORT.getRouteKey());
//    }
////~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /**
     * 创建文章专栏通知队列
     */
    @Bean
    public Queue articleColumnNoticeDelayedQueue(){
        return new Queue("articleColumnNoticeDelayedQueue");
    }
     ...
     */
    @Bean
    public CustomExchange articleColumnNoticeDelayExchange(){
        Map<String, Object> args = new HashMap<>();
        args.put("x-delayed-type", "direct");
        return new CustomExchange("articleColumnNoticeDelayExchange", "x-delayed-message", true, false, args);
    }

    /**
     * 绑定文章专栏通知队列到文章专栏通知延迟交换机
     */
    @Bean
    public Binding articleColumnNoticeDelayBinding(CustomExchange articleColumnNoticeDelayExchange,Queue articleColumnNoticeDelayedQueue){
        return BindingBuilder
                .bind(articleColumnNoticeDelayedQueue).
                to(articleColumnNoticeDelayExchange).
                with("articleColumnNoticeDelayedQueue.routingkey")
                .noargs();
    }
